...
{
	/// <summary>
	/// Entity implementation for table 'CURRENT_INCOME'.
	/// </summary>
	/// <remarks>
	/// ** OK to Add modifications to this file **
	/// </remarks>
	[Serializable]
	public class CurrentIncome : CurrentIncomeBase, OrcaLogic.Xml.IXmlFactoryElement
	{
		...
		/// </summary>
		public CurrentIncome(System.Int64 id) : base(id)
		{
		}
		...
		protected virtual bool ProcessAttribute(ref System.Collections.DictionaryEntry attributeEntry)
		{
			...
			switch(key)
			{
				case "IncomeType":
				{
					attributeEntry.Value = string.Format("{0}", ((Enums.IncomeType) attributeEntry.Value));
					break;
				}
				case "MonthlyTotalAmount":
				{
