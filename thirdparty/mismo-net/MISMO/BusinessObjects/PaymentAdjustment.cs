...
{
	/// <summary>
	/// Entity implementation for table 'PAYMENT_ADJUSTMENT'.
	/// </summary>
	/// <remarks>
	/// ** OK to Add modifications to this file **
	/// </remarks>
	[Serializable]
	public class PaymentAdjustment : PaymentAdjustmentBase, IXmlFactoryElement
	{
		...
		/// </summary>
		public PaymentAdjustment(System.Int64 productDataId) : base(productDataId)
		{
		}
