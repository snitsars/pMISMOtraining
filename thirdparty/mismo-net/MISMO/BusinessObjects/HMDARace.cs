...
{
	/// <summary>
	/// Entity implementation for table 'HMDA_RACE'.
	/// </summary>
	/// <remarks>
	/// ** OK to Add modifications to this file **
	/// </remarks>
	[Serializable]
	public class HMDARace : HMDARaceBase, OrcaLogic.Xml.IXmlFactoryElement
	{
		...
		/// </summary>
		public HMDARace(System.Int64 id) : base(id)
		{
		}
		...
		protected virtual bool ProcessAttribute(ref System.Collections.DictionaryEntry attributeEntry)
		{
			...
			switch(key)
			{
				case "Type":
				{
					...
					attributeEntry.Value = string.Format("{0}", ((Enums.HMDARaceType) attributeEntry.Value));
					break;
				}
			}
