...
{
	/// <summary>
	/// Entity implementation for table 'LOAN_PRODUCT_DATA'.
	/// </summary>
	/// <remarks>
	/// ** OK to Add modifications to this file **
	/// </remarks>
	[Serializable]
	public class LoanProductData : LoanProductDataBase, IXmlFactoryElement
	{
		...
		/// </summary>
		public LoanProductData(System.Int64 loanApplicationId) : base(loanApplicationId)
		{
		}
